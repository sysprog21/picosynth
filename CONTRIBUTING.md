# Contributing to `picosynth`

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to [picosynth](https://github.com/sysprog21/picosynth)
...
Visit our [Issues page on GitHub](https://github.com/sysprog21/picosynth/issues) to search and submit.
